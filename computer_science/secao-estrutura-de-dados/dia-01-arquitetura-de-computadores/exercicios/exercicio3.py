...
# script chamado resources.py e utilize-o para exibir no console as informações
# solicitadas abaixo. Para isso, utilize o método check_output do módulo
...
# Informações sobre a memória RAM (no Linux você pode usar comando free,
# e no OSX você pode usar o comando top -l 1 | head -n 10 | grep PhysMem):
