...
# def test_wrong_is_odd_when_number_is_even_returns_false():
#     'Para um número par a função deve retornar o valor False'
...
# uma determinada
# pessoa cliente pede um determinado prato, considerando que os pedidos estão
# em uma lista.
...
# novamente adicionamos um cenário (contexto) ao teste onde os pedidos
# realizados são os
# definidos na fixture


# def test_get_order_frequency_per_costumer_when_customer_is_
# joao_and_order_is_pizza(orders):
#     assert get_order_frequency_per_costumer(orders, "joao", "pizza") == 0


# def test_get_order_frequency_per_costumer_when_customer_
# is_maria_and_order_is_hamburger(orders):
#     assert get_order_frequency_per_costumer
# (orders, "maria", "hamburger") == 1
