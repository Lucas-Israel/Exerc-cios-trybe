...
import json
import pytest
from pokemon import retrieve_pokemons_by_type, retrieve_pokemons_by_type_v2
...
def test_retrieve_pokemons_by_type_v2():
    ...
    with patch("builtins.open", mock_open(read_data=pokemon_json_content)):
        ...
        assert retrieve_pokemons_by_type_v2("Grass", "dummy") == [
            grass_type_pokemon
        ]
