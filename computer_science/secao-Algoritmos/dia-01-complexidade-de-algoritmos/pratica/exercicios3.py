...
# candies[i] representa o número de doces que a enésima criança possui.

# Para cada criança, verifique se há uma maneira de distribuir doces
# extras entre as crianças de forma que ela possa ter o maior número de doces
# entre elas.
...
# a função faz O(2n) que é resumida para O(n) para todos os casos ja que vai
# passar sempre por toda a lista.
