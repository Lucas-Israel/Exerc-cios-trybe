...
# ⚠️ Para verificar se a requisição foi bem sucedida, faça assert
# "bot detected" not in response.text.
# Se nada acontecer, seu código está funcionando.

# ⚠️ Faça a inspeção de como a requisição é feita pelo navegador para conseguir
